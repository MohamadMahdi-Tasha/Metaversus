...
export default function SixthSectionComponent():JSX.Element {
    ...
    return(
        <SectionComponent className={'lg:mt-[200px] mt-[100px]'}>
            <PreTitlesComponent>| People on the World</PreTitlesComponent>
            <TitlesComponent>Track friends around you and invite them to play together in the same world</TitlesComponent>
