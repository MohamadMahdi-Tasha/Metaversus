...
export default function EighthSectionComponent():JSX.Element {
    ...
    return (
        <SectionComponent className={'mt-[200px] relative flex'}>
            <figure className={'w-[370px] h-[610px] mr-[10px] flex flex-col p-[30px] justify-end items-start rounded-[32px] border border-[#6A6A6A] bg-pink-gradiant bg-left-top bg-contain bg-no-repeat'}>
