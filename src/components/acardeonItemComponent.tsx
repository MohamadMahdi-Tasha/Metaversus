...
export default function AcardeonItemComponent({bg, name, isOpened, onClick}:propsType): JSX.Element {
    // returning jsx
    return (
        <div onClick={onClick} data-opened={isOpened} className={'text-white relative flex overflow-hidden flex-col justify-end cursor-pointer rounded-[24px] p-[32px] transition-all h-[563px] data-[opened="true"]:w-[370px] data-[opened="false"]:w-[170px] [&>div]:data-[opened="false"]:opacity-0 [&>span:first-of-type]:data-[opened="false"]:opacity-0 [&>span:last-of-type]:data-[opened="false"]:rotate-[-90deg] [&>span:last-of-type]:data-[opened="false"]:ml-[70px]'}>
