...
export default function MouseRotatingAnimationComponent({className}:propsType):JSX.Element {
    // Returning JSX
    return (
       <div className={(className === undefined) ? 'bg-[rgba(256,256,256,.08)] flex items-center justify-center rounded-full aspect-square backdrop-blur absolute lg:w-[170px] w-[100px]' : `lg:w-[130px] w-[130px] flex items-center justify-center bg-[rgba(256,256,256,.08)] aspect-square rounded-full backdrop-blur absolute ${className}`}>
           <img src={TextImage} alt="EXPLORE AND ENTER THE METAVERSE" className={'aspect-ratio lg:w-[130px] w-[100px] animate-spin-slow'}/>
